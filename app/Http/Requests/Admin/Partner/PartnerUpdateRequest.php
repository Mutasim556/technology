...
class PartnerUpdateRequest extends FormRequest
{
    ...
    public function update(string $id){
        $support = Partner::where([['id',$id]])->first();
        ...
        if($this->partner_image){
            ...
            $manager->read($this->partner_image)->resize(130,130)->save(env('ASSET_DIRECTORY').'/admin/inventory/file/partner/'.$file);

        }else{
            $partner_image = $support->partner_image;
        }
