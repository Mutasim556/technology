...
class CreateSolutionParentCategoryRequest extends FormRequest
{
    /**
    ...
    public function store(){
        if($this->parent_category_image){
            ...
            $manager->read($this->parent_category_image)->resize(50,50)->save('admin/inventory/file/solution/parent_category/'.$file);
        }else{
            $file_name = "";
        }

        $parent_category = new SolutionParentCategory();
