...
class SolutionUpdateRequest extends FormRequest
{
    ...
    public function update($id){
        ...
        $solution_details = SolutionDetail::where('solution_id',$id)->first();
        ...
        if ($this->downloads_file) {
            ...
            $downloads_file = $solution_details->download_file;
        }
