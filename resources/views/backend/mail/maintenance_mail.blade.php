              ...
              <tbody>
                <tr>
                  <td style="padding: 30px"> 
                    <h6 style="font-weight: 600">Software is going to maintenance mode </h6>
                    <p></p>
                    ...
                    <p style="text-align: center">Secret Key for Access : {{ $secret_key }}</p>

                    <p>Sorry ! Hope it will make our system more efficient.</p>
