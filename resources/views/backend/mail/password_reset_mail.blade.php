              ...
              <tbody>
                <tr>
                  <td style="padding: 30px"> 
                    ...
                    <p>You forgot your password for {{ env('APP_BACKEND_NAME') }}. If this is true, click below to reset your password and use the below code .</p>
                    <p style="text-align: center">Reset Code : {{ $code }}</p>
                    <p style="text-align: center"><a href="{{ route('admin.reset_password') }}" style="padding: 10px; background-color:#5c61f2; color: #fff; display: inline-block; border-radius:5px; font-weight:700; padding:0.6rem 1.75rem;">Reset Password</a></p>
