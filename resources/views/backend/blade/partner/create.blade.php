...
@section('content')
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-sm-6">
                    <h3>{{ __('admin_local.Add Partner') }}</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ __('admin_local.Add Partner') }}</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-10 mx-auto">
                <div class="card">
                    <div class="card-header py-3" style="border-bottom: 2px dashed gray">
                        <h3 class="card-title mb-0 text-center">{{ __('admin_local.Add Partner') }}</h3>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <form action="theme-form" id="add_partner_form" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4" id="category_div">
                                            ...
                                            <input type="date" class="form-control" name="partner_join_date" id="partner_join_date">
                                        ...
                                        <div class="form-group col-md-6" id="category_div">
                                            ...
                                            <input type="text" class="form-control" name="partner_contact_number" id="partner_contact_number">
                                        ...
                                        <div class="form-group col-md-12" id="category_div">
                                            ...
                                            <textarea id="editor1" name="partner_address" ></textarea>
