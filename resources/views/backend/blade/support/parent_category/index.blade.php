...
@section('content')
    <div class="container-fluid">
        <div class="page-title">
            <div class="row">
                <div class="col-sm-6">
                    <h3>{{ __('admin_local.Support Parent Category List') }}</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ __('admin_local.Support Parent Category List') }}</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                <div class="modal-header d-flex align-items-center" style="border-bottom:1px dashed gray">
                    <h4 class="modal-title" id="myLargeModalLabel">
                        {{ __('admin_local.Add Support Parent Category') }}
                    </h4>
    ...
    <div class="modal fade" id="edit-parent-category-modal" tabindex="-1" aria-labelledby="bs-example-modal-lg"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header d-flex align-items-center" style="border-bottom:1px dashed gray">
                    <h4 class="modal-title" id="myLargeModalLabel">
                        {{ __('admin_local.Edit Support Parent Category') }}
                    </h4>
                    <button type="button" class="btn-close " data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <p class="px-3 text-danger"><i>{{ __('admin_local.The field labels marked with * are required input fields.') }}</i>
            ...
            <div class="col-lg-10 mx-auto">
                <div class="card">
                    <div class="card-header py-3" style="border-bottom: 2px dashed gray">
                        <h3 class="card-title mb-0 text-center">{{ __('admin_local.Support Parent Category List') }}</h3>
                    </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    <button class="btn btn-success" type="btn" data-bs-toggle="modal"
                                        data-bs-target="#add-parent-category-modal">+ {{ __('admin_local.Add Support Parent Category') }}</button>
                                </div>
                            </div>
                        @endif
...
@push('js')
    ...
    <script>
        ...
        var form_url = "{{ route('admin.support.parent-category.store') }}";
    ...
    <script src="{{ asset(env('ASSET_DIRECTORY').'/'.'admin/custom/support/parent_category.js') }}"></script>
