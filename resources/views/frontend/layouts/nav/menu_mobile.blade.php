                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="dropdown">
                        @foreach ($parent_category->category as $category)
                            @php
                                $sub_categories = DB::table('sub_categories')->where([['sub_category_status',1],['sub_category_delete',0],['category_id', $category->id]])->select('id','sub_category_name')->get();
                            @endphp
                            <li class="menu-item-has-children">
                                ...
                                <ul class="dropdown">
                                    ...
                                    @foreach ($sub_categories as $sub_category)
                                        <li><a href="shop-product-right.html">{{ $sub_category->sub_category_name }}</a></li>
                                    @endforeach
                                </ul>
                                @endif
